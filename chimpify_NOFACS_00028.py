...
os.chdir(os.path.expanduser('~/Documents/chimpify/testNOFAC')) #assign the default directory files saves to
...
class Application(Frame): #create class (create definition of the object)
    ...
    def initUI(self): #create the runUI as an object
        ...
        self.parent.title("LMS, Inc. - chimpify@NOFACS - Created by MLAROE") #Window title
        ...
        self.txt.pack(fill=BOTH, expand=1) #for displaying contents of the file in the window 
    ...
    def read_clickCSV(self, filename): #defines everything done to the clicks-csv
        ...
        csv_inputclicks.insert(4, 'Opened', 1)
        csv_inputclicks.insert(5, 'Bounce', '')
        csv_inputclicks.insert(6, 'unsubscribe_reason', '')
        csv_inputclicks.insert(7, 'Unsub', '')
    ...
    def read_openedCSV(self, filename):
        ...
        csv_inputopened.insert(4, 'Opened', 1)
        csv_inputopened.insert(5, 'Bounce', '')
        csv_inputopened.insert(6, 'unsubscribe_reason', '')
        csv_inputopened.insert(7, 'Unsub', '')
        csv_inputopened.insert(8, 'URL', '')
        csv_inputopened.insert(9, 'Clicks', '')
    ...
    def notOpened(self, filename):
        ...
        csv_notopened.insert(4, 'Opened', 0)
        csv_notopened.insert(5, 'Bounce', '')
        csv_notopened.insert(6, 'unsubscribe_reason', '')
        csv_notopened.insert(7, 'Unsub', '')
        csv_notopened.insert(8, 'URL', '')
        csv_notopened.insert(9, 'Clicks', '')
    ...
    def bounces(self, filename):
        ...
        csv_bounced.insert(4, 'Opened', '')
        csv_bounced.rename(columns={'Bounce Type': 'Bounce'}, inplace=True)
        csv_bounced.insert(6, 'unsubscribe_reason', '')
        csv_bounced.insert(7, 'Unsub', '')
        csv_bounced.insert(8, 'URL', '')
        csv_bounced.insert(9, 'Clicks', '')
    ...
    def unsubs(self, filename):
        ...
        csv_unsubs.insert(5, 'Unsub', 1)
        csv_unsubs.insert(4, 'Opened', '')
        csv_unsubs.insert(5, 'Bounce', '')
        csv_unsubs.insert(8, 'URL', '')
        csv_unsubs.insert(9, 'Clicks', '')
    ...
    def allfilesConcat (self, filenames):
        ...
        print("oh boy!", filename2)
        print("woozah!", filename3)
        print("ZOMG!!", filename4)
        print(allconcat, "huzzah!")
        
        allconcat.rename(columns = {'Email Address': 'Email_Address', 'Name 1': 'Name_1', 'Member Rating': 'Member_Rating'}, inplace = True)
